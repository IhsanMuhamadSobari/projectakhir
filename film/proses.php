...
if(isset($_POST['submit'])){
    ...
    $query = mysqli_query($conn, "insert into film set gambar = '$gambar', judul = '$judul', tahun_rilis = '$tahun_rilis', rating = '$rating', genre = '$genre', sinopsis = '$sinopsis', aktor = '$aktor', sutradara = '$sutradara', penulis = '$penulis'");
...
function upload()
    {
        ...
        if(!in_array($ekstensiGambar, $ekstensiGambarCek)){
            $message = "Anda Belum Upload Gambar!";
            $message = urlencode($message);
            header("Location:add_film.php?message={$message}");
            return false;
        }
